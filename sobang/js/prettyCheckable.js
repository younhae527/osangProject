...
;(function ( $, window, undefined ) {
    ...
    function addCheckableEvents(element) {
      ...
      element.find('a, label').on('touchstart click', function(e){
        ...
        if (input.prop('disabled') === true) {
              fakeCheckable.attr('title','선택해제되었습니다.');
        ...
        if (input.prop('type') === 'radio') {
          ...
          $('input[name="' + input.attr('name') + '"]').each(function(index, el){
            ...
            $(el).prop('checked', false).parent().find('a').removeClass('checked');
              $(el).prop('checked', false).parent().find('a').attr('title','선택해제되었습니다.')
          });
        ...
        if (window.ko) {
          ...
          if (input.prop('checked')) {
              ...
              fakeCheckable.attr('title','선택되었습니다.')
          }
    ...
    Plugin.prototype.init = function () {
      ...
      if (labelPosition === 'labelright') {
        ...
        dom.push('<a href="#redirect" class="' + isChecked + ' linkhide">해당항목 선택하기</a>');
        // dom.push('<label for="' + el.attr('id') + '">' + label + '</label>');

      } else {

        // dom.push('<label for="' + el.attr('id') + '">' + label + '</label>');
        dom.push('<a href="#redirect" class="' + isChecked + '></a>');
